...
// ── Neighbourhood card photos — /assets/img/coquitlam/ ──────────────────────────
$nb_photos = [
    'mountain-meadows-coq'   => '/assets/img/coquitlam/Mountain Meadows.webp',
    'coquitlam-west'         => '/assets/img/coquitlam/Coquitlam West.webp',
    'harbour-chines'         => '/assets/img/coquitlam/Harbour Chines.webp',
    'harbour-place'          => '/assets/img/coquitlam/Harbour Place.webp',
    'chineside'              => '/assets/img/coquitlam/Chineside.webp',
    'westwood-plateau'       => '/assets/img/coquitlam/Westwood Plateau.webp',
    'westwood-summit'        => '/assets/img/coquitlam/Westwood Summit.webp',
    'summit-view'            => '/assets/img/coquitlam/Summit View.webp',
    'upper-eagle-ridge'      => '/assets/img/coquitlam/Upper Eagle Ridge.webp',
    'eagle-ridge-coq'        => '/assets/img/coquitlam/Eagle Ridge.webp',
    'ranch-park'             => '/assets/img/coquitlam/Ranch Park.webp',
    'scott-creek'            => '/assets/img/coquitlam/Scott Creek.webp',
    'canyon-springs'         => '/assets/img/coquitlam/Canyon Springs.webp',
    'north-coquitlam'        => '/assets/img/coquitlam/North Coquitlam.webp',
    'meadowbrook'            => '/assets/img/coquitlam/Meadowbrook.webp',
    'coquitlam-east'         => '/assets/img/coquitlam/Coquitlam East.webp',
    'cape-horn'              => '/assets/img/coquitlam/Cape Horn.webp',
    'central-coquitlam'      => '/assets/img/coquitlam/Central Coquitlam.webp',
    'maillardville'          => '/assets/img/coquitlam/Maillardville.webp',
    'hockaday'               => '/assets/img/coquitlam/Hockaday.webp',
    'burke-mountain'         => '/assets/img/coquitlam/Burke Mountain.webp',
    'river-springs'          => '/assets/img/coquitlam/River Springs.webp',
    'new-horizons'           => '/assets/img/coquitlam/New Horizons.webp',
    'park-ridge-estates'     => '/assets/img/coquitlam/Park Ridge Estates.webp',
];
...
$geoMap = [
    ...
    'Habour Chines'      => ['harbour-chines'],
    'Habour Place'       => ['harbour-place'],
    'Chineside'          => ['chineside'],
    'Westwood Plateau'   => ['westwood-plateau'],
    'Westwood Summit'    => ['westwood-summit'],
    'Summit View'        => ['summit-view'],
    'Upper Eagle Creek'  => ['upper-eagle-ridge'],
    'Eagle Ridge'        => ['eagle-ridge-coq'],
    'Range Park'         => ['ranch-park'],
...
try {
    $q = $pdo->prepare("
        ...
        WHERE nb.area='Coquitlam' AND nb.is_active=1
...
<!-- HERO -->
<div class="nbcity-hero" style="background-image:url('/assets/img/coquitlam/coquitlam-hero.webp');">
    ...
    <div class="container h-100 position-relative" style="z-index:2;">
        <div class="row h-100 align-items-center">
            <div class="col-lg-7">
                ...
                <h1 class="nbcity-title">Coquitlam</h1>
...
<section style="background:#fff;padding:0;overflow:hidden;">
    <div style="display:flex;align-items:stretch;min-height:480px;">
        ...
        ">
            <div class="nbcity-label">About Coquitlam</div>
            <p class="nbcity-intro-body">Coquitlam is one of Metro Vancouver’s fastest-growing cities — offering an exceptional mix of established family neighbourhoods, master-planned communities, and dramatic natural scenery. From the vibrant transit hub of North Coquitlam to the forested trails of Burke Mountain and Westwood Plateau, the city caters to a wide range of lifestyles and budgets.</p>
...
<section style="background:#f8f9fc;padding:60px 0 90px;">
    <div class="container">
        <div class="row mb-3 align-items-center">
            <div class="col"><div class="nbcity-area-label">Coquitlam Neighbourhoods</div></div>
            <div class="col-auto"><span style="font-size:12px;color:#aaa;font-weight:600;"><?= $total ?> neighbourhoods</span></div>
        </div>

        <?php if (!empty($nbs)): ?>
        <div class="row g-3 mb-2" id="coq-visible">
        ...
        <?php if (!empty($hidden)): ?>
        <div class="row g-3 mb-2" id="coq-hidden" style="display:none;">
        ...
        <div class="text-center mt-2">
            <button class="nbcity-expand-btn" onclick="toggleSection('coq-hidden','coq-btn',<?= $total ?>)" id="coq-btn">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function makePopup(geoName, slugs) {
        ...
        return '<div style="font-family:system-ui;min-width:210px;">'
            +'<div style="font-size:10px;color:#0065ff;font-weight:700;text-transform:uppercase;letter-spacing:.7px;margin-bottom:6px;">Coquitlam</div>'
    ...
    fetch('metro-vancouver.geojson')
        ...
        .then(function(data) {
            ...
            data.features.forEach(function(f) {
                ...
                if (!city || city === 'coquitlam' || !otherCities[city]) return;
            ...
            // ── Step 2: Load Coquitlam neighbourhoods on top ───────────────────────────────
            return fetch('coquitlam-boundaries.geojson');
        })
        .then(function(r){ return r.json(); })
