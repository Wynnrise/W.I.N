...
// ── School catchment (neighbourhood based) ───────────────────────────────────
            ...
            <div class="featured_slick_padd">
                <a href="<?= htmlspecialchars($photo) ?>" class="mfp-gallery">
                    <img src="<?= htmlspecialchars($photo) ?>" class="img-fluid mx-auto"
                         style="width:100%;height:700px;object-fit:cover;" alt="<?= htmlspecialchars($p['address']) ?>" loading="lazy">
                </a>
            </div>
            <?php endforeach; ?>
        <?php else: ?>
            <?php for ($i = 0; $i < 4; $i++): ?>
            <div class="featured_slick_padd">
                <div class="sp2-hero-placeholder">
                ...
                <div class="property_block_wrap style-3">
                    ...
                    <div class="pbw-flex-1">
                        ...
                        <div class="pbw-flex-thumb p-3">
                            <img src="<?= htmlspecialchars($p['builder_logo']) ?>"
                                 style="max-height:80px;max-width:160px;object-fit:contain;" alt="Builder Logo">
                        </div>
                        <?php else: ?>
                        <div class="pbw-flex-thumb p-3 sp2-logo-placeholder">
                            <i class="fas fa-building"></i>
                        </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="pbw-flex">
                        <div class="prt-detail-title-desc">
                            ...
                            <span><i class="lni-map-marker"></i>
                                <?= htmlspecialchars($p['neighborhood']) ?>, Vancouver, BC
                            </span>
                            <h3 class="prt-price-fix text-primary mt-2">
                                <?= !empty($p['price']) ? htmlspecialchars($p['price']) : 'T.B.A.' ?>
                            </h3>
                            <div class="list-fx-features">
                                ...
                                <div class="listing-card-info-icon">
                                    <div class="inc-fleat-icon me-1"><img src="<?= $static_url ?>/img/bed.svg" width="13" alt=""></div>
                                    <?= $p['bedrooms'] ?> Beds
                                </div>
                                <?php endif; ?>
                                <?php if (!empty($p['bathrooms'])): ?>
                                <div class="listing-card-info-icon">
                                    <div class="inc-fleat-icon me-1"><img src="<?= $static_url ?>/img/bathtub.svg" width="13" alt=""></div>
                                    <?= $p['bathrooms'] ?> Baths
                                </div>
                                <?php endif; ?>
                                <?php if (!empty($p['sqft'])): ?>
                                <div class="listing-card-info-icon">
                                    <div class="inc-fleat-icon me-1"><img src="<?= $static_url ?>/img/move.svg" width="13" alt=""></div>
            ...
            <div class="col-lg-8 col-md-12 col-sm-12">
                ...
                <div class="property_block_wrap">
                    <div class="property_block_wrap_header">
                        <h4 class="property_block_title">About This Development</h4>
                    </div>
                ...
                <div class="property_block_wrap">
                    ...
                    <div class="block-body">
                        <div class="amenities-grid">
                            ...
                            <div class="amenity-tag"><i class="fas fa-check"></i><?= htmlspecialchars($amenity) ?></div>
                            <?php endforeach; ?>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="block-body">
                        ...
                        <?php if ($fp_ext === 'pdf'): ?>
                            <div class="floorplan-pdf-wrap">
                                ...
                                <div><strong>Floor Plan Available</strong><small>PDF Document</small></div>
                        ...
                        <?php else: ?>
                            <a href="<?= htmlspecialchars($p['floorplan']) ?>" target="_blank">
                                <img src="<?= htmlspecialchars($p['floorplan']) ?>" alt="Floor Plan"
                ...
                <div id="gallery-modal" class="gallery-modal" style="display:none;" onclick="this.style.display='none'">
                    <div class="gallery-modal-inner" onclick="event.stopPropagation()">
                        ...
                        <div class="gallery-modal-grid">
                            <?php if ($has_photos): ?>
                                <?php foreach ($photos as $photo): ?>
                                <div style="aspect-ratio:4/3;border-radius:6px;overflow:hidden;">
                                    <img src="<?= htmlspecialchars($photo) ?>" style="width:100%;height:100%;object-fit:cover;" loading="lazy">
                                </div>
                                <?php endforeach; ?>
                            <?php else: ?>
                                <?php for ($g = 0; $g < 6; $g++): ?>
                                <div class="gallery-modal-tile"><i class="fas fa-camera"></i><span>Coming Soon</span></div>
                                <?php endfor; ?>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="block-body">
                        ...
                        <div class="school-catchment-grid">
                            <div class="school-card">
                                ...
                                <a href="https://www.vsb.bc.ca" target="_blank" class="school-link"><i class="fas fa-external-link-alt"></i></a>
                            </div>
                            <div class="school-card">
                        ...
                        <p style="font-size:11px;color:#bbb;margin-top:12px;">
                            Always verify with the <a href="https://www.vsb.bc.ca/Student_Registration/Pages/School-Locator.aspx" target="_blank" style="color:#0065ff;">VSB School Locator</a>.
                        </p>
                        <?php else: ?>
                        <div class="coming-soon-block">
                            <i class="fas fa-graduation-cap"></i>
                            <p>School catchment info for <strong><?= htmlspecialchars($p['neighborhood']) ?></strong> will be added shortly.</p>
                            <a href="https://www.vsb.bc.ca/Student_Registration/Pages/School-Locator.aspx" target="_blank" class="coming-soon-tag" style="text-decoration:none;">Check VSB School Locator →</a>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="property_block_wrap">
                    ...
                    <div class="block-body">
                        ...
                        <script type="text/javascript">
                            ...
                            var ws_format='wide';var ws_width='600';var ws_height='200';
                            var ws_transit='1';var ws_bike='1';
                        </script>
                        <div id="ws-walkscore-tile">
                            <div id="ws-loading" style="color:#bbb;font-size:12px;padding:10px 0;"><i class="fas fa-circle-notch fa-spin me-2"></i>Loading scores...</div>
                        </div>
                        <script>(function(){var s=document.createElement('script');s.type='text/javascript';s.async=true;s.src='https://www.walkscore.com/tile/show-walkscore-tile.php';s.onload=function(){var l=document.getElementById('ws-loading');if(l)l.remove();};document.body.appendChild(s);})();</script>
                    ...
                    <div class="block-body">
                        ...
                        <div class="nearby-links-row">
                            <a href="<?= $yelp_url ?>" target="_blank" rel="noopener" class="nearby-link-btn yelp">
                                ...
                                <div><strong>Search Yelp</strong><span>Restaurants & cafés near this address</span></div>
                            ...
                            <a href="<?= $gmaps_url ?>" target="_blank" rel="noopener" class="nearby-link-btn gmaps">
                                ...
                                <div><strong>Google Maps Nearby</strong><span>See restaurants on the map</span></div>
                                <i class="fas fa-external-link-alt" style="flex-shrink:0;opacity:.6;"></i>
                            </a>
                        </div>
                    </div>
...
<style>
/* ── Section blocks ───────────────────────────────────────────────────── */
.property_block_wrap { background:#fff; border-radius:8px; margin-bottom:24px; overflow:hidden; }
.property_block_wrap_header { padding:18px 24px 14px; border-bottom:1px solid #f0f0f0; }
.property_block_title { margin:0; font-size:18px; font-weight:700; color:#002446; }
.block-body { padding:20px 24px; }
/* ── Hero placeholder ─────────────────────────────────────────────────── */
.sp2-hero-placeholder { width:100%;height:280px;background:linear-gradient(135deg,#002446,#004080,#0065ff);display:flex;flex-direction:column;align-items:center;justify-content:center;color:rgba(255,255,255,.85);gap:10px; }
.sp2-hero-placeholder i { font-size:56px;opacity:.6; }
.sp2-hero-placeholder span { font-size:14px;font-weight:700;text-transform:uppercase;letter-spacing:1px; }
.sp2-hero-placeholder small { font-size:12px;opacity:.65; }
/* ── Builder logo placeholder ─────────────────────────────────────────── */
.sp2-logo-placeholder { display:flex;align-items:center;justify-content:center;background:#f0f3f8;border-radius:8px;width:120px;height:80px; }
.sp2-logo-placeholder i { font-size:36px;color:#c0ccd8; }
/* ── Coming soon ──────────────────────────────────────────────────────── */
.coming-soon-block { display:flex;flex-direction:column;align-items:center;justify-content:center;padding:36px 20px;background:#f8f9fb;border:2px dashed #d0d8e8;border-radius:8px;text-align:center;color:#aab;gap:10px; }
.coming-soon-block i { font-size:36px;opacity:.4; }
.coming-soon-block p { margin:0;font-size:13px;color:#889;line-height:1.6; }
.coming-soon-tag { display:inline-block;background:#e8f0ff;color:#0065ff;font-size:11px;font-weight:700;letter-spacing:.8px;text-transform:uppercase;padding:3px 12px;border-radius:20px; }
/* ── T.B.A. ───────────────────────────────────────────────────────────── */
.tba-detail { color:#aaa;font-style:italic;font-size:12px; }
/* ── Amenities ────────────────────────────────────────────────────────── */
.amenities-grid { display:grid;grid-template-columns:repeat(auto-fill,minmax(180px,1fr));gap:10px; }
.amenity-tag { display:flex;align-items:center;gap:8px;background:#f0f4ff;border:1px solid #dce8ff;border-radius:8px;padding:9px 14px;font-size:13px;font-weight:500;color:#002446; }
.amenity-tag i { color:#0065ff;font-size:11px;flex-shrink:0; }
/* ── Features ─────────────────────────────────────────────────────────── */
.detail-features-list { list-style:none;padding:0;margin:0;display:grid;grid-template-columns:repeat(auto-fill,minmax(200px,1fr));gap:8px; }
.detail-features-list li { display:flex;align-items:center;gap:8px;font-size:13px;color:#444;padding:6px 0;border-bottom:1px solid #f5f5f5; }
...
.gallery-tile-label { font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.8px;color:#bbc; }
.gallery-real-tile { aspect-ratio:4/3;border-radius:6px;overflow:hidden;position:relative;cursor:pointer; }
.gallery-real-tile img { width:100%;height:100%;object-fit:cover;display:block;transition:transform .3s; }
.gallery-real-tile:hover img { transform:scale(1.05); }
.gallery-tile-hover { position:absolute;inset:0;background:rgba(0,36,70,.4);display:flex;align-items:center;justify-content:center;opacity:0;transition:opacity .2s;color:#fff;font-size:22px; }
.gallery-real-tile:hover .gallery-tile-hover { opacity:1; }
.gallery-expand-overlay { position:absolute;bottom:0;right:0;width:calc(33.33% - 5px);aspect-ratio:4/3;background:rgba(0,36,70,.82);border-radius:6px;display:flex;flex-direction:column;align-items:center;justify-content:center;color:#fff;cursor:pointer;gap:8px;transition:background .2s; }
.gallery-expand-overlay:hover { background:rgba(0,101,255,.88); }
.gallery-expand-overlay i { font-size:22px; }
.gallery-expand-overlay span { font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.8px; }
/* ── Gallery modal ────────────────────────────────────────────────────── */
.gallery-modal { position:fixed;inset:0;background:rgba(0,0,0,.92);z-index:9999;display:flex;align-items:center;justify-content:center;padding:20px; }
...
.gallery-modal-close { position:absolute;top:16px;right:16px;background:rgba(255,255,255,.1);border:none;color:#fff;width:34px;height:34px;border-radius:50%;cursor:pointer;font-size:14px;display:flex;align-items:center;justify-content:center; }
.gallery-modal-close:hover { background:#0065ff; }
.gallery-modal-grid { display:grid;grid-template-columns:repeat(3,1fr);gap:10px; }
.gallery-modal-tile { aspect-ratio:4/3;background:#1e2836;border:2px dashed #2d3d52;border-radius:6px;display:flex;flex-direction:column;align-items:center;justify-content:center;color:#445;gap:8px; }
/* ── Floor plan ───────────────────────────────────────────────────────── */
.floorplan-pdf-wrap { display:flex;align-items:center;gap:16px;background:#f8f9fb;border:1px solid #e2e8f0;border-radius:10px;padding:20px; }
...
.btn-view-fp { background:#002446;color:#fff;padding:10px 18px;border-radius:8px;font-size:13px;font-weight:600;text-decoration:none;white-space:nowrap;transition:background .2s; }
.btn-view-fp:hover { background:#0065ff;color:#fff; }
/* ── School catchment ─────────────────────────────────────────────────── */
.school-catchment-grid { display:flex;flex-direction:column;gap:12px; }
.school-card { display:flex;align-items:center;gap:16px;background:#f8f9fb;border:1px solid #e2e8f0;border-radius:10px;padding:16px;transition:box-shadow .2s; }
.school-card:hover { box-shadow:0 4px 16px rgba(0,36,70,.08); }
...
.school-type { font-size:10px;text-transform:uppercase;letter-spacing:.8px;color:#aaa;font-weight:600; }
.school-name { font-size:14px;font-weight:700;color:#002446; }
.school-board { font-size:11px;color:#888; }
.school-link { color:#ccd;font-size:13px;text-decoration:none;padding:8px;border-radius:6px;transition:color .2s,background .2s; }
...
.nearby-link-btn:hover { box-shadow:0 4px 16px rgba(0,0,0,.1);transform:translateY(-1px); }
...
.btn-bottom-nav { display:flex;align-items:center;justify-content:center;padding:13px 20px;border-radius:10px;font-size:14px;font-weight:600;text-decoration:none;transition:all .2s; }
.btn-bottom-nav.secondary { background:#f1f5f9;color:#002446;border:1px solid #e2e8f0; }
.btn-bottom-nav.secondary:hover { background:#e2e8f0; }
</style>

<script>
function openModal(idx) { document.getElementById('gallery-modal').style.display='flex'; }
</script>
<?php include "$base_dir/Components/Home/coming-soon-copyright.php"; ?>
<?php
