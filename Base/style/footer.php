<footer class="dark-footer skin-dark-footer">
    <div class="footer-top">
        <div class="container">
            <div class="row">
                ...
                <!-- ── Brand + Brokerage Disclosure ── -->
                <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                    <div class="footer-widget">
                        <a class="nav-footer-logo" href="index.php">
                            <img src="<?php echo $static_url; ?>/img/logo-light.png" class="logo" alt="Wynston" style="height:46px;">
                        </a>
                        <p class="footer-tagline"></p>

                        <!-- Brokerage Disclosure — legally required on all advertising -->
                        <div class="footer-brokerage">
                            <div class="footer-brokerage-inner">
                                <img src="<?php echo $static_url; ?>/img/royal-pacific-logo.png"
                                     alt="Royal Pacific Realty"
                                     class="footer-rp-logo">
                                <div class="footer-brokerage-text">
                                    <div class="footer-brokerage-name">Tam Nguyen, REALTOR®</div>
                                    <div class="footer-brokerage-firm">Royal Pacific Realty Corp.</div>
                                    <div class="footer-brokerage-reg">Independently Owned &amp; Operated<br>Real Estate Board of Greater Vancouver<br>BC Financial Services Authority</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-2 col-md-3 col-sm-6 mb-4">
                    <div class="footer-widget">
                        ...
                        <ul class="footer-menu">
                            ...
                            <li><a href="half-map.php">Pre-Sale Listings</a></li>
                            <li><a href="active-listings.php">Active MLS® Listings</a></li>
                            <li><a href="about-us.php">About Wynston</a></li>
                ...
                <div class="col-lg-2 col-md-3 col-sm-6 mb-4">
                    <div class="footer-widget">
                        <h4 class="widget-title">For Developers</h4>
                        <ul class="footer-menu">
                            <li><a href="create-account.php">Submit a Free Listing</a></li>
                            <li><a href="create-account.php">Creative Package</a></li>
                            <li><a href="create-account.php">Concierge Service</a></li>
                            <li><a href="developer-dashboard.php">Developer Portal</a></li>
                            <li><a href="log-in.php">Developer Login</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-4 col-sm-6 mb-4">
                    <div class="footer-widget">
                        ...
                        <ul class="footer-menu">
                            ...
                            <li><a href="disclaimer.php#d-mls">MLS® Attribution</a></li>
                            <li><a href="disclaimer.php#d-redma">REDMA Notice</a></li>
                        </ul>
                    </div>
                </div>

                <!-- ── Download Apps (unchanged) ── -->
                <div class="col-lg-3 col-md-8 col-sm-6 mb-4">
                    <div class="footer-widget">
    ...
    <!-- ── MLS® Data Disclaimer Bar ── -->
    <div class="footer-mls-bar">
        <div class="container">
            <div class="footer-mls-inner">
                <span class="footer-mls-badge">MLS®</span>
                <p>The data relating to real estate on this website comes in part from the MLS® Reciprocity program of the Real Estate Board of Greater Vancouver. Listing data is deemed reliable but not guaranteed accurate. All measurements and details should be independently verified. E.&amp;O.E. Active listing data provided under license to <strong st>Tam Nguyen, REALTOR®, Royal Pacific Realty Corporation </strong>. The trademarks MLS®, Multiple Listing Service®, and associated logos are owned by CREA. <strong> © <?php echo date('Y'); ?> Wynston.ca — Proprietary Coming Soon Database.</strong>
                ...
                <a href="terms.php#s7">See Section 7 of our Terms of Service →</a></p>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-5 col-md-6">
                    <p class="mb-0">© <?php echo date('Y'); ?> Wynston Real Estate &nbsp;·&nbsp; Tam Nguyen, REALTOR® &nbsp;·&nbsp; Royal Pacific Realty Corp.</p>
                </div>

                <div class="col-lg-4 col-md-6 text-center footer-legal-row">
...
.footer-brokerage-firm {
    font-size: 12px;
    color: rgba(255,255,255,.75);
    font-weight: 600;
    margin: 2px 0 4px;
}
.footer-brokerage-reg {
    font-size: 11px;
...
.footer-legal-row a:hover { color: #c9a84c; }
.footer-legal-row span { color: rgba(255,255,255,.2); font-size: 10px; }

/* ── Mobile ────────────────────────────────────────────────────────── */
@media (max-width: 767px) {
    .footer-legal-row { margin: 8px 0; justify-content: flex-start; }
    .footer-bottom .text-right { text-align: left !important; margin-top: 8px; }
    .footer-mls-inner { flex-direction: column; gap: 8px; }
}
</style>