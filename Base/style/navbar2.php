        ...
        <nav id="navigation" class="navigation navigation-landscape">
            ...
            <div class="nav-menus-wrapper" style="transition-property: none;">
                ...
                <li class="relative parent-parent-menu-item">
                     ...
                     <li class="relative parent-parent-menu-item">
                        <a href="neighbourhoods.php" class="home-link">Neighbourhoods</a>
                    </li>
                    <li class="relative parent-parent-menu-item">
...
/* ── Alignment fix ── */
ul.nav-menu-social.align-to-right { display:flex !important; align-items:center !important; flex-wrap:nowrap !important; }
ul.nav-menu-social.align-to-right > li { display:flex !important; align-items:center !important; float:none !important; vertical-align:middle !important; padding-top:0 !important; padding-bottom:0 !important; line-height:1 !important; }
</style>
<script>
