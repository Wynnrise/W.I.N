    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row align-items-center">
                ...
                <p class="mb-0">© 2025 Resido. Develop with <i class="mdi mdi-heart text-danger"></i> By <a href="https://shreethemes.in/" target="_blank" class="text-reset">Shreethemes</a>.</p>
                </div>
