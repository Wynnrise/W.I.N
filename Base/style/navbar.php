        ...
        <nav id="navigation" class="navigation navigation-landscape">
            <div class="nav-header">
                <a class="nav-brand" href="index.php">
                    <img src="<?php echo $static_url; ?>/img/favicon.png" class="logo" alt="Multi Lists" style="height: 50px;">
                    <img src="<?php echo $static_url; ?>/img/favicon.png" class="fixed-logo" alt="Multi Lists" style="height: 50px;">
                </a>
                </a>
                </a>
            ...
            <div class="nav-menus-wrapper" style="transition-property: none;">
                ...
                <ul class="nav-menu nav-menu-social align-to-right">
                    ...
                    if (!empty($_SESSION['dev_id'])): ?>
                        <a href="developer-dashboard.php" class="fw-medium text-muted-2 dev-nav-btn">
                    ...
                    <?php else: ?>
                        <a href="log-in.php" class="fw-medium text-muted-2">
