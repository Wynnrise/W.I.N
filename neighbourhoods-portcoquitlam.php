...
// ── Neighbourhood card photos — /assets/img/port-coquitlam/ ───────────────────
$nb_photos = [
    'woodland-acres-poc'     => '/assets/img/port-coquitlam/Woodland Acres.webp',
    'glenwood-poc'           => '/assets/img/port-coquitlam/Glenwood.webp',
    'oxford-heights'         => '/assets/img/port-coquitlam/Oxford Heights.webp',
    'lincoln-park-poc'       => '/assets/img/port-coquitlam/Lincoln Park.webp',
    'birchland-manor'        => '/assets/img/port-coquitlam/Birchland Manor.webp',
    'riverwood'              => '/assets/img/port-coquitlam/Riverwood.webp',
    'citadel-poc'            => '/assets/img/port-coquitlam/Citadel.webp',
    'mary-hill'              => '/assets/img/port-coquitlam/Mary Hill.webp',
    'lower-mary-hill'        => '/assets/img/port-coquitlam/Lower Mary Hill.webp',
    'central-port-coquitlam' => '/assets/img/port-coquitlam/Central Port Coquitlam.webp',
];

// ── GeoJSON NAME → DB slug(s) ──────────────────────────────────────────
$geoMap = [
    'Woodland Acres'         => ['woodland-acres-poc'],
    'Glennwood'              => ['glenwood-poc'],
    'Oxford Heights'         => ['oxford-heights'],
    'Lincoln Park'           => ['lincoln-park-poc'],
    'Birchland Manor'        => ['birchland-manor'],
    'River Wood'             => ['riverwood'],
    'Citadel'                => ['citadel-poc'],
    'Mary Hill'              => ['mary-hill'],
...
try {
    $q = $pdo->prepare("
        ...
        WHERE nb.area='Port Coquitlam' AND nb.is_active=1
...
<!-- HERO -->
<div class="nbcity-hero" style="background-image:url('/assets/img/port-coquitlam/port-coquitlam-hero.webp');">
    ...
    <div class="container h-100 position-relative" style="z-index:2;">
        <div class="row h-100 align-items-center">
            <div class="col-lg-7">
                ...
                <h1 class="nbcity-title">Port Coquitlam</h1>
...
<section style="background:#fff;padding:0;overflow:hidden;">
    <div style="display:flex;align-items:stretch;min-height:480px;">
        ...
        ">
            <div class="nbcity-label">About Port Coquitlam</div>
            <p class="nbcity-intro-body">Port Coquitlam — affectionately known as PoCo — is a tight-knit, family-oriented city nestled between the Pitt and Fraser Rivers at the eastern edge of the Tri-Cities. With a walkable downtown, excellent schools, and some of the most affordable detached homes in Metro Vancouver, it draws young families and first-time buyers.</p>
...
<section style="background:#f8f9fc;padding:60px 0 90px;">
    <div class="container">
        <div class="row mb-3 align-items-center">
            <div class="col"><div class="nbcity-area-label">Port Coquitlam Neighbourhoods</div></div>
            <div class="col-auto"><span style="font-size:12px;color:#aaa;font-weight:600;"><?= $total ?> neighbourhoods</span></div>
        </div>

        <?php if (!empty($nbs)): ?>
        <div class="row g-3 mb-2" id="poc-visible">
        ...
        <?php if (!empty($hidden)): ?>
        <div class="row g-3 mb-2" id="poc-hidden" style="display:none;">
        ...
        <div class="text-center mt-2">
            <button class="nbcity-expand-btn" onclick="toggleSection('poc-hidden','poc-btn',<?= $total ?>)" id="poc-btn">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function makePopup(geoName, slugs) {
        ...
        return '<div style="font-family:system-ui;min-width:210px;">'
            +'<div style="font-size:10px;color:#0065ff;font-weight:700;text-transform:uppercase;letter-spacing:.7px;margin-bottom:6px;">Port Coquitlam</div>'
    ...
    fetch('metro-vancouver.geojson')
        ...
        .then(function(data) {
            ...
            data.features.forEach(function(f) {
                ...
                if (!city || city === 'portcoquitlam' || !otherCities[city]) return;
            ...
            // ── Step 2: Load Port Coquitlam neighbourhoods on top ───────────────────────
            return fetch('port-coquitlam-boundaries.geojson');
        })
        .then(function(r){ return r.json(); })
