...
// ── Neighbourhood card photos — /assets/img/new-westminster/ ─────────────────
$nb_photos = [
    'brunette-nw'       => '/assets/img/new-westminster/Brunette.webp',
    'connaught-heights' => '/assets/img/new-westminster/Connaught Heights.webp',
    'downtown-nw'       => '/assets/img/new-westminster/Downtown.webp',
    'fraserview-nw'     => '/assets/img/new-westminster/Fraserview.webp',
    'glenbrooke-north'  => '/assets/img/new-westminster/Glenbrooke North.webp',
    'moody-park'        => '/assets/img/new-westminster/Moody Park.webp',
    'north-arm-nw'      => '/assets/img/new-westminster/North Arm.webp',
    'queens-park-nw'    => "/assets/img/new-westminster/Queen Park.webp",
    'queensborough-nw'  => '/assets/img/new-westminster/Queensborough.webp',
    'sapperton'         => '/assets/img/new-westminster/Sapperton.webp',
    'the-heights-nw'    => '/assets/img/new-westminster/The Heights.webp',
    'uptown-nw'         => '/assets/img/new-westminster/Uptown.webp',
    'west-end-nw'       => '/assets/img/new-westminster/West End.webp',
    'quay-nw'           => '/assets/img/new-westminster/Quay.webp',
];

// GeoJSON NAME → DB slug(s)
$geoMap = [
    'Queensborough'     => ['queensborough-nw'],
    'North Arm'         => ['north-arm-nw'],
    'Quay'              => ['quay-nw'],
    'Connaught Heights' => ['connaught-heights'],
    'West End'          => ['west-end-nw'],
    'Moody Park'        => ['moody-park'],
    'Uptown'            => ['uptown-nw'],
    'Downtown'          => ['downtown-nw'],
    "Queen's Park"      => ['queens-park-nw'],
    'Glenbrooke North'  => ['glenbrooke-north'],
    'Fraserview'        => ['fraserview-nw'],
    'Sapperton'         => ['sapperton'],
    'The Heights'       => ['the-heights-nw'],
    'Brunette'          => ['brunette-nw'],
];
...
try {
    $q = $pdo->prepare("
        ...
        WHERE nb.area='New Westminster' AND nb.is_active=1
...
<!-- HERO -->
<div class="nbcity-hero" style="background-image:url('/assets/img/new-westminster/new-westminster-hero.webp');">
    ...
    <div class="container h-100 position-relative" style="z-index:2;">
        <div class="row h-100 align-items-center">
            <div class="col-lg-7">
                ...
                <h1 class="nbcity-title">New Westminster</h1>
...
<section style="background:#fff;padding:0;overflow:hidden;">
    <div style="display:flex;align-items:stretch;min-height:480px;">
        ...
        ">
            <div class="nbcity-label">About New Westminster</div>
            <p class="nbcity-intro-body">New Westminster is Metro Vancouver’s original city — a compact, walkable grid perched above the Fraser River with some of the region’s most storied neighbourhoods. From the Victorian homes of Queen’s Park to the waterfront condos of the Quay, New West offers urban density with genuine community character.</p>
            <p class="nbcity-intro-body">Direct SkyTrain access makes it one of the most connected cities in the region. Wynston tracks all <?= $total ?> MLS sub-areas with real monthly market data.</p>
...
<section style="background:#f8f9fc;padding:60px 0 90px;">
    <div class="container">
        <div class="row mb-3 align-items-center">
            <div class="col"><div class="nbcity-area-label">New Westminster Neighbourhoods</div></div>
            <div class="col-auto"><span style="font-size:12px;color:#aaa;font-weight:600;"><?= $total ?> neighbourhoods</span></div>
        </div>

        <?php if (!empty($nbs)): ?>
        <div class="row g-3 mb-2" id="nw-visible">
        ...
        <?php if (!empty($hidden)): ?>
        <div class="row g-3 mb-2" id="nw-hidden" style="display:none;">
        ...
        <div class="text-center mt-2">
            <button class="nbcity-expand-btn" onclick="toggleSection('nw-hidden','nw-btn',<?=$total?>)" id="nw-btn">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ── New Westminster neighbourhood data ────────────────────────────────────
    var bySlug = {};
    ...
    function makePopup(geoName, slugs) {
        ...
        return '<div style="font-family:system-ui;min-width:210px;">'
            +'<div style="font-size:10px;color:#0065ff;font-weight:700;text-transform:uppercase;letter-spacing:.7px;margin-bottom:6px;">New Westminster</div>'
    ...
    fetch('metro-vancouver.geojson')
        ...
        .then(function(data) {
            ...
            data.features.forEach(function(f) {
                ...
                if (!city || city === 'newwestminster' || !otherCities[city]) return;
            ...
            // ── Step 2: Load New Westminster neighbourhoods on top ─────────────
            return fetch('newwestminster-boundaries.geojson');
        })
        .then(function(r){ return r.json(); })
