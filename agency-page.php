			...
			<div class="col-lg-12 col-md-12">
				<div class="agency agency-list overlio-40">
					...
					<div class="agency-avatar">
						<img src="<?php echo !empty($article['img']) ? $static_url . $article['img'] : $static_url . '/img/ag-1.png'; ?>" alt="">
					</div>
			...
			<div class="col-lg-8 col-md-12 col-sm-12">
				...
				<div class="block-wrap">
					...
					<div class="block-header ags">
						...
						<a href="add-agent.php" class="btn btn-seegreen">Add New Agent</a>
					</div>
							...
							<div class="tab-content" id="pills-tabContent">
								...
								<div class="tab-pane fade show active" id="agent" role="tabpanel" aria-labelledby="agent-tab">
									...
									<div class="row justify-content-center g-4">
										...
										<!-- single-agent1 code  -->
										<?php
											include "$base_dir/Components/Features/single-agent1.php";
										?>
												...
												<div class="listing-img-wrapper p-3">
													<div class="list-img-slide position-relative">
														...
														<div class="clicks rounded-3 overflow-hidden">
															<div><img src="<?php echo $static_url; ?>/img/p-3.jpg" class="img-fluid mx-auto" alt="" /></div>
														</div>
													</div>
												</div>
											...
											<div class="property-listing card border rounded-3">
												...
												<div class="listing-img-wrapper p-3">
													<div class="list-img-slide position-relative">
														...
														<div class="clicks rounded-3 overflow-hidden">
															<div><img src="<?php echo $static_url; ?>/img/p-4.jpg" class="img-fluid mx-auto" alt="" /></div>
														</div>
													</div>
												</div>
											...
											<div class="property-listing card border rounded-3">
												...
												<div class="listing-img-wrapper p-3">
													<div class="list-img-slide position-relative">
														...
														<div class="clicks rounded-3 overflow-hidden">
															<div><img src="<?php echo $static_url; ?>/img/p-5.jpg" class="img-fluid mx-auto" alt="" /></div>
														</div>
													</div>
												</div>
											...
											<div class="property-listing card border rounded-3">
												...
												<div class="listing-img-wrapper p-3">
													<div class="list-img-slide position-relative">
														...
														<div class="clicks rounded-3 overflow-hidden">
															<div><img src="<?php echo $static_url; ?>/img/p-6.jpg" class="img-fluid mx-auto" alt="" /></div>
														</div>
													</div>
												</div>
											...
											<div class="property-listing card border rounded-3">
												...
												<div class="listing-img-wrapper p-3">
													<div class="list-img-slide position-relative">
														...
														<div class="clicks rounded-3 overflow-hidden">
															<div><img src="<?php echo $static_url; ?>/img/p-7.jpg" class="img-fluid mx-auto" alt="" /></div>
														</div>
													</div>
												</div>
											...
											<div class="property-listing card border rounded-3">
												...
												<div class="listing-img-wrapper p-3">
													<div class="list-img-slide position-relative">
														...
														<div class="clicks rounded-3 overflow-hidden">
															<div><img src="<?php echo $static_url; ?>/img/p-8.jpg" class="img-fluid mx-auto" alt="" /></div>
														</div>
													</div>
												</div>
				...
				<div class="details-sidebar">
					...
					<div class="sides-widget">
						<div class="sides-widget-header">
							<div class="agent-photo"><img src="<?php echo $static_url; ?>/img/user-6.jpg" alt=""></div>
						...
						<div class="sides-widget-body simple-form">
							...
							<button class="btn btn-dark btn-md rounded full-width">Send Message</button>
						</div>
					</div>
