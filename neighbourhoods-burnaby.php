...
// ── Neighbourhood card photos — /assets/img/burnaby/ ──────────────────────────
$nb_photos = [
    // Burnaby South
    'big-bend'               => '/assets/img/burnaby/Big Bend.webp',
    'buckingham-heights'     => '/assets/img/burnaby/Buckingham Heights.webp',
    'burnaby-hospital'       => '/assets/img/burnaby/Burnaby Hospital.webp',
    'burnaby-lake'           => '/assets/img/burnaby/Burnaby Lake.webp',
    'central-park-bn'        => '/assets/img/burnaby/Central Park.webp',
    'deer-lake'              => '/assets/img/burnaby/Deer Lake.webp',
    'deer-lake-place'        => '/assets/img/burnaby/Deer Lake Place.webp',
    'forest-glen-bs'         => '/assets/img/burnaby/Forest Glen.webp',
    'garden-village'         => '/assets/img/burnaby/Garden Village.webp',
    'greentree-village'      => '/assets/img/burnaby/Greentree Village.webp',
    'highgate'               => '/assets/img/burnaby/Highgate.webp',
    'metrotown'              => '/assets/img/burnaby/Metrotown.webp',
    'oaklands'               => '/assets/img/burnaby/Oaklands.webp',
    'south-slope'            => '/assets/img/burnaby/South Slope.webp',
    'suncrest'               => '/assets/img/burnaby/Suncrest.webp',
    'upper-deer-lake'        => '/assets/img/burnaby/Upper Deer Lake.webp',
    // Burnaby East
    'edmonds-bn'             => '/assets/img/burnaby/Edmonds.webp',
    'the-crest'              => '/assets/img/burnaby/The Crest.webp',
    // Burnaby North
    'brentwood-park-bn'      => '/assets/img/burnaby/Brentwood Park.webp',
    'capitol-hill-bn'        => '/assets/img/burnaby/Capitol Hill.webp',
    'cariboo'                => '/assets/img/burnaby/Cariboo.webp',
    'central-bn'             => '/assets/img/burnaby/Central Burnaby.webp',
    'forest-hills-bn'        => '/assets/img/burnaby/Forest Hills.webp',
    'government-road'        => '/assets/img/burnaby/Government Road.webp',
    'lake-city-industrial'   => '/assets/img/burnaby/Lake City Industrial.webp',
    'montecito'              => '/assets/img/burnaby/Montecito.webp',
    'oakdale'                => '/assets/img/burnaby/Oakdale.webp',
    'parkcrest'              => '/assets/img/burnaby/Parkcrest.webp',
    'simon-fraser-hills'     => '/assets/img/burnaby/Simon Fraser Hills.webp',
    'simon-fraser-university'=> '/assets/img/burnaby/Simon Fraser University.webp',
    'sperling-duthie'        => '/assets/img/burnaby/Sperling-Duthie.webp',
    'sullivan-heights'       => '/assets/img/burnaby/Sullivan Heights.webp',
    'vancouver-heights'      => '/assets/img/burnaby/Vancouver Heights.webp',
    'westridge-bn'           => '/assets/img/burnaby/Westridge.webp',
    'willingdon-heights'     => '/assets/img/burnaby/Willingdon Heights.webp',
];

// ── Section slugs — defines which section each neighbourhood belongs to ────────
$south_slugs = ['big-bend','buckingham-heights','burnaby-hospital','burnaby-lake',
    'central-park-bn','deer-lake','deer-lake-place','forest-glen-bs','garden-village',
    'greentree-village','highgate','metrotown','oaklands','south-slope','suncrest','upper-deer-lake'];

$east_slugs  = ['edmonds-bn','the-crest'];

$north_slugs = ['brentwood-park-bn','capitol-hill-bn','cariboo','central-bn',
    'forest-hills-bn','government-road','lake-city-industrial','montecito','oakdale',
    'parkcrest','simon-fraser-hills','simon-fraser-university','sperling-duthie',
    'sullivan-heights','vancouver-heights','westridge-bn','willingdon-heights'];
...
$geoMap = [
    ...
    'Brentwood Park'         => ['brentwood-park-bn'],
    ...
    'Oakdale'                => ['oakdale'],
    'Montecito'              => ['montecito'],
    'Westridge'              => ['westridge-bn'],
    'Forest Hills'           => ['forest-hills-bn'],
...
try {
    $q = $pdo->prepare("
        ...
        WHERE nb.area='Burnaby' AND nb.is_active=1
...
$nbs_south = array_values(array_filter($nbs, fn($n) => in_array($n['slug'], $south_slugs)));
$nbs_east  = array_values(array_filter($nbs, fn($n) => in_array($n['slug'], $east_slugs)));
$nbs_north = array_values(array_filter($nbs, fn($n) => in_array($n['slug'], $north_slugs)));
$total     = count($nbs);
...
<!-- HERO -->
<div class="nbcity-hero" style="background-image:url('/assets/img/burnaby/burnaby-hero.webp');">
    ...
    <div class="container h-100 position-relative" style="z-index:2;">
        <div class="row h-100 align-items-center">
            <div class="col-lg-7">
                ...
                <h1 class="nbcity-title">Burnaby</h1>
...
<section style="background:#fff;padding:0;overflow:hidden;">
    <div style="display:flex;align-items:stretch;min-height:480px;">
        ...
        ">
            <div class="nbcity-label">About Burnaby</div>
            <p class="nbcity-intro-body">Burnaby sits at the geographic heart of Metro Vancouver — anchored by world-class transit at Brentwood and Metrotown, surrounded by the natural beauty of Burnaby Lake and Burnaby Mountain.</p>
            <p class="nbcity-intro-body">Home to some of the region's most ambitious new development, Wynston tracks all <?= $total ?> MLS sub-areas across Burnaby South, East, and North with real monthly market data.</p>
...
<!-- NEIGHBOURHOOD CARDS — 3 sections -->
<section style="background:#f8f9fc;padding:60px 0 90px;">
    <div class="container">

<?php
// ── Helper to render a section of cards ───────────────────────────────────────
function render_section(array $nbs, string $label, string $section_id, array $nb_photos): void {
    if (empty($nbs)) return;
    $count   = count($nbs);
    ...
    ?>
        <div class="row mb-3 align-items-center">
            <div class="col"><div class="nbcity-area-label"><?= htmlspecialchars($label) ?></div></div>
            <div class="col-auto"><span style="font-size:12px;color:#aaa;font-weight:600;"><?= $count ?> neighbourhoods</span></div>
        </div>
        <div class="row g-3 mb-2" id="<?= $section_id ?>-visible">
        ...
        <?php if (!empty($hidden)): ?>
        <div class="row g-3 mb-2" id="<?= $section_id ?>-hidden" style="display:none;">
        ...
        <div class="text-center mt-2 mb-5">
            <button class="nbcity-expand-btn" onclick="toggleSection('<?= $section_id ?>-hidden','<?= $section_id ?>-btn',<?= $count ?>)" id="<?= $section_id ?>-btn">
                <i class="fas fa-th me-2"></i>Show all <?= $count ?> neighbourhoods
            </button>
        </div>
        <?php else: ?>
        <div class="mb-5"></div>
...
?>
        ...
        <?php if (!empty($nbs)): ?>
            <?php render_section($nbs_south, 'Burnaby South', 'south', $nb_photos); ?>
            <?php render_section($nbs_east,  'Burnaby East',  'east',  $nb_photos); ?>
            <?php render_section($nbs_north, 'Burnaby North', 'north', $nb_photos); ?>
        <?php else: ?>
...
<style>
.nbcity-hero{position:relative;height:580px;display:flex;align-items:center;background-size:cover;background-position:center 75%;}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Enable scroll zoom on click, disable on mouse leave
    ...
    var active    = null; // active Burnaby neighbourhood layer
    var activeCity = null; // active other-city layer
    ...
    function makePopup(geoName, slugs) {
        ...
        return '<div style="font-family:system-ui;min-width:210px;">'
            +'<div style="font-size:10px;color:#0065ff;font-weight:700;text-transform:uppercase;letter-spacing:.7px;margin-bottom:6px;">Burnaby</div>'
    ...
    fetch('metro-vancouver.geojson')
        ...
        .then(function(data) {
            // Group features by city, skip Burnaby
            var byCity = {};
            data.features.forEach(function(f) {
                var city = f.properties.CITY;
                if (!city || city === 'burnaby' || !otherCities[city]) return;
            ...
            Object.keys(byCity).forEach(function(cityKey) {
                ...
                // City label at centre
                var bounds = layer.getBounds();
                if (bounds.isValid()) {
                    L.tooltip({
                        permanent: true, direction: 'center',
                        className: 'nb-city-tip', interactive: false, opacity: 1
                    })
                    .setContent(otherCities[cityKey].label)
                    .setLatLng(bounds.getCenter())
                    .addTo(map);
                }

                layer.on('mouseover', function() {
                    if (layer !== activeCity) layer.setStyle(cityHov);
                });
                layer.on('mouseout', function() {
                    if (layer !== activeCity) layer.setStyle(cityDef);
                });
                layer.on('click', function(e) {
                    if (activeCity && activeCity !== layer) activeCity.setStyle(cityDef);
                    layer.setStyle(cityAct);
                    activeCity = layer;
            ...
            // ── Step 2: Load Burnaby neighbourhoods on top ────────────────────
            return fetch('burnaby-boundaries.geojson');
        })
        .then(function(r){ return r.json(); })
            ...
            L.geoJSON(geojsonData, {
                ...
                onEachFeature: function(feature, layer) {
                    ...
                    layer.on({
                        ...
                        click: function(e) {
                            // Close any active city highlight
