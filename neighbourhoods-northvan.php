...
// ── Neighbourhood card photos — /assets/img/north-vancouver/ ────────────────────────────────────
$nb_photos = [
    'central-lonsdale'    => '/assets/img/north-vancouver/Central Lonsdale.webp',
    'lower-lonsdale'      => '/assets/img/north-vancouver/Lower Lonsdale.webp',
    'upper-lonsdale'      => '/assets/img/north-vancouver/Upper Lonsdale.webp',
    'lynnmour'            => '/assets/img/north-vancouver/Lynnmour.webp',
    'queensbury'          => '/assets/img/north-vancouver/Queensbury.webp',
    'blueridge-nv'        => '/assets/img/north-vancouver/Blueridge.webp',
    'boulevard'           => '/assets/img/north-vancouver/Boulevard.webp',
    'canyon-heights-nv'   => '/assets/img/north-vancouver/Canyon Heights.webp',
    'capilano-highlands'  => '/assets/img/north-vancouver/Capilano Highlands.webp',
    'deep-cove'           => '/assets/img/north-vancouver/Deep Cove.webp',
    'dollarton'           => '/assets/img/north-vancouver/Dollarton.webp',
    'edgemont'            => '/assets/img/north-vancouver/Edgemont.webp',
    'grouse-woods'        => '/assets/img/north-vancouver/Grouse Woods.webp',
    'indian-river'        => '/assets/img/north-vancouver/Indian River.webp',
    'lynn-valley'         => '/assets/img/north-vancouver/Lynn Valley.webp',
    'pemberton-heights'   => '/assets/img/north-vancouver/Pemberton Heights.webp',
    'seymour'             => '/assets/img/north-vancouver/Seymour.webp',
    'northlands'          => '/assets/img/north-vancouver/Northlands.webp',
    'braemar'             => '/assets/img/north-vancouver/Braemar.webp',
    'tempe'               => '/assets/img/north-vancouver/Tempe.webp',
    'westlynn'            => '/assets/img/north-vancouver/Westlynn.webp',
    'westlynn-terrace'    => '/assets/img/north-vancouver/Westlynn Terrace.webp',
    'calverhall'          => '/assets/img/north-vancouver/Calverhall.webp',
    'harbourside'         => '/assets/img/north-vancouver/Harbourside.webp',
    'mosquito-creek'      => '/assets/img/north-vancouver/Mosquito Creek.webp',
    'norgate'             => '/assets/img/north-vancouver/Norgate.webp',
    'pemberton'           => '/assets/img/north-vancouver/Pemberton.webp',
    'roche-point'         => '/assets/img/north-vancouver/Roche Point.webp',
    'windsor-park'        => '/assets/img/north-vancouver/Windsor Park.webp',
    'woodlands-sunshine'  => '/assets/img/north-vancouver/Woodlands-Sunshine.webp',
    'forest-hills-nv'     => '/assets/img/north-vancouver/Forest Hills.webp',
    'upper-delbrook'      => '/assets/img/north-vancouver/Upper Delbrook.webp',
    'delbrook'            => '/assets/img/north-vancouver/Delbrook.webp',
    'princess-park'       => '/assets/img/north-vancouver/Princess Park.webp',
];
...
try {
    $q = $pdo->prepare("
        ...
        WHERE nb.area IN ('City of North Vancouver','District of North Vancouver') AND nb.is_active=1
...
$cityNbs     = array_values(array_filter($nbs, fn($n) => $n['area'] === 'City of North Vancouver'));
$districtNbs = array_values(array_filter($nbs, fn($n) => $n['area'] === 'District of North Vancouver'));
$total       = count($nbs);
...
$geoMap = [
    ...
    'Canyon Heights'     => ['canyon-heights-nv'],
    'Grouse Woods'       => ['grouse-woods'],
    'Upper Delbrook'     => ['upper-delbrook'],
    'Forest Hills'       => ['forest-hills-nv'],
    'Delbrook'           => ['delbrook'],
...
<!-- HERO -->
<div class="nbcity-hero" style="background-image:url('/assets/img/north-vancouver/north-vancouver-hero.webp');">
    ...
    <div class="container h-100 position-relative" style="z-index:2;">
        <div class="row h-100 align-items-center">
            <div class="col-lg-7">
                ...
                <h1 class="nbcity-title">North Vancouver</h1>
...
<section style="background:#fff;padding:0;overflow:hidden;">
    <div style="display:flex;align-items:stretch;min-height:480px;">
        ...
        ">
            <div class="nbcity-label">About North Vancouver</div>
            <p class="nbcity-intro-body">North Vancouver is where urban convenience meets mountain lifestyle. Separated from downtown Vancouver by Burrard Inlet, the North Shore offers buyers a rare combination — walkable village centres in Lower and Central Lonsdale, and family-oriented hillside communities in Lynn Valley and Edgemont.</p>
            <p class="nbcity-intro-body">With unmatched access to Grouse Mountain, Seymour, and hundreds of kilometres of trails, Wynston tracks all <?= $total ?> MLS sub-areas with real monthly market data.</p>
...
<section style="background:#f8f9fc;padding:60px 0 90px;">
    <div class="container">
        ...
        <?php if (!empty($cityNbs)): ?>
        <div class="row mb-3 align-items-center">
            <div class="col"><div class="nbcity-area-label">City of North Vancouver</div></div>
            <div class="col-auto"><span style="font-size:12px;color:#aaa;font-weight:600;"><?= count($cityNbs) ?> neighbourhoods</span></div>
        </div>
        <div class="row g-3 mb-2" id="city-visible">
            <?php foreach (array_slice($cityNbs,0,4) as $nb):
        ...
        <?php if (count($cityNbs) > 4): ?>
        <div class="row g-3 mb-2" id="city-hidden" style="display:none;">
            <?php foreach (array_slice($cityNbs,4) as $nb):
                $slug=$nb['slug']; $photo=$nb_photos[$slug]??''; $cnt=(int)$nb['cs_count']+(int)$nb['active_count'];
                $link='neighbourhood.php?slug='.urlencode($slug).'&hero='.urlencode($photo); ?>
            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                <a href="<?= $link ?>" class="nbcity-nb-card">
        ...
        <div class="text-center mt-2 mb-5">
            <button class="nbcity-expand-btn" onclick="toggleSection('city-hidden','city-btn',<?=count($cityNbs)?>)" id="city-btn">
                <i class="fas fa-th me-2"></i>Show all <?= count($cityNbs) ?> City neighbourhoods
            </button>
        </div>
        <?php else: ?><div class="mb-5"></div><?php endif; ?>
        <?php endif; ?>

        <?php if (!empty($districtNbs)): ?>
        <div class="row mb-3 align-items-center">
            <div class="col"><div class="nbcity-area-label">District of North Vancouver</div></div>
            <div class="col-auto"><span style="font-size:12px;color:#aaa;font-weight:600;"><?= count($districtNbs) ?> neighbourhoods</span></div>
        </div>
        <div class="row g-3 mb-2" id="dist-visible">
            <?php foreach (array_slice($districtNbs,0,4) as $nb):
                $slug=$nb['slug']; $photo=$nb_photos[$slug]??''; $cnt=(int)$nb['cs_count']+(int)$nb['active_count'];
                $link='neighbourhood.php?slug='.urlencode($slug).'&hero='.urlencode($photo); ?>
            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                <a href="<?= $link ?>" class="nbcity-nb-card">
        ...
        <?php if (count($districtNbs) > 4): ?>
        <div class="row g-3 mb-2" id="dist-hidden" style="display:none;">
            <?php foreach (array_slice($districtNbs,4) as $nb):
                $slug=$nb['slug']; $photo=$nb_photos[$slug]??''; $cnt=(int)$nb['cs_count']+(int)$nb['active_count'];
                $link='neighbourhood.php?slug='.urlencode($slug).'&hero='.urlencode($photo); ?>
            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                <a href="<?= $link ?>" class="nbcity-nb-card">
        ...
        <div class="text-center mt-2">
            <button class="nbcity-expand-btn" onclick="toggleSection('dist-hidden','dist-btn',<?=count($districtNbs)?>)" id="dist-btn">
                <i class="fas fa-th me-2"></i>Show all <?= count($districtNbs) ?> District neighbourhoods
            </button>
        </div>
        <?php endif; ?>
        <?php endif; ?>
...
<style>
.nbcity-hero{position:relative;height:580px;display:flex;align-items:center;background-size:cover;background-position:center 15%;}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ── North Vancouver neighbourhood data ────────────────────────────────────
    var bySlug = {};
    ...
    function makePopup(geoName, slugs) {
        ...
        return '<div style="font-family:system-ui;min-width:210px;">'
            +'<div style="font-size:10px;color:#0065ff;font-weight:700;text-transform:uppercase;letter-spacing:.7px;margin-bottom:6px;">North Vancouver</div>'
    ...
    fetch('metro-vancouver.geojson')
        ...
        .then(function(data) {
            ...
            data.features.forEach(function(f) {
                ...
                if (!city || city === 'northvan' || !otherCities[city]) return;
            ...
            // ── Step 2: Load North Van neighbourhoods on top ──────────────────
            return fetch('northvancouver-boundaries.geojson');
        })
        .then(function(r){ return r.json(); })
