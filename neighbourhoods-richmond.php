...
// ── Neighbourhood card photos — /assets/img/richmond/ ─────────────────────────
$nb_photos = [
    'boyd-park'         => '/assets/img/richmond/Boyd Park.webp',
    'bridgeport-ri'     => '/assets/img/richmond/Bridgeport.webp',
    'brighouse'         => '/assets/img/richmond/Brighouse.webp',
    'brighouse-south'   => '/assets/img/richmond/Brighouse South.webp',
    'broadmoor'         => '/assets/img/richmond/Broadmoor.webp',
    'east-cambie'       => '/assets/img/richmond/East Cambie.webp',
    'east-richmond-ri'  => '/assets/img/richmond/East Richmond.webp',
    'garden-city'       => '/assets/img/richmond/Garden City.webp',
    'gilmore-ri'        => '/assets/img/richmond/Gilmore.webp',
    'granville'         => '/assets/img/richmond/Granville.webp',
    'hamilton-ri'       => '/assets/img/richmond/Hamilton.webp',
    'ironwood'          => '/assets/img/richmond/Ironwood.webp',
    'lackner'           => '/assets/img/richmond/Lackner.webp',
    'mclennan'          => '/assets/img/richmond/McLennan.webp',
    'mclennan-north'    => '/assets/img/richmond/McLennan North.webp',
    'mcnair'            => '/assets/img/richmond/McNair.webp',
    'quilchena-ri'      => '/assets/img/richmond/Quilchena.webp',
    'riverdale-ri'      => '/assets/img/richmond/Riverdale.webp',
    'saunders-ri'       => '/assets/img/richmond/Saunders.webp',
    'seafair'           => '/assets/img/richmond/Seafair.webp',
    'sea-island-ri'     => '/assets/img/richmond/Sea Island.webp',
    'south-arm-ri'      => '/assets/img/richmond/South Arm.webp',
    'steveston-north'   => '/assets/img/richmond/Steveston North.webp',
    'steveston-south'   => '/assets/img/richmond/Steveston South.webp',
    'steveston-village' => '/assets/img/richmond/Steveston Village.webp',
    'terra-nova'        => '/assets/img/richmond/Terra Nova.webp',
    'west-cambie-ri'    => '/assets/img/richmond/West Cambie.webp',
    'westwind-ri'       => '/assets/img/richmond/Westwind.webp',
    'woodwards-ri'      => '/assets/img/richmond/Woodwards.webp',
];

// Returns the card/hero photo for a neighbourhood
function nb_photo(array $nb): string {
    global $nb_photos;
    if (isset($nb_photos[$nb['slug']])) {
        return htmlspecialchars($nb_photos[$nb['slug']]);
    }
    // Fallback for any new neighbourhood not yet in the list
    if (!empty($nb['hero_image'])) {
        return htmlspecialchars($nb['hero_image']);
    }
    $city_word  = explode(' ', $nb['area'])[0];
    $nb_keyword = preg_replace('/\s+(VE|VW|RI|NV|WV|BN|BE|BS|PM|PoC)$/i', '', $nb['name']);
    return 'https://source.unsplash.com/600x400/?' . urlencode($nb_keyword . ' ' . $city_word);
}

// ── GeoJSON NAME → DB slug(s) ─────────────────────────────────────────────────
$geoMap = [
    'Bridgeport'      => ['bridgeport-ri'],
    'East Richmond'   => ['east-richmond-ri'],
    'Hamilton'        => ['hamilton-ri'],
    'Gilmore'         => ['gilmore-ri'],
    'Westwind'        => ['westwind-ri'],
    'Steveston South' => ['steveston-south'],
    'Steveston Village'=> ['steveston-village'],
    'Steveston North' => ['steveston-north'],
    'Woodwards'       => ['woodwards-ri'],
    'Broadmoor'       => ['broadmoor'],
    'South Arm'       => ['south-arm-ri'],
    'Saunders'        => ['saunders-ri'],
    'McNair'          => ['mcnair'],
    'Ironwood'        => ['ironwood'],
    'McLennan'        => ['mclennan'],
    ...
    'Boyd Park'       => ['boyd-park'],
    'Seafair'         => ['seafair'],
    'Quilchena'       => ['quilchena-ri'],
    'Granville'       => ['granville'],
    'Terra Nova'      => ['terra-nova'],
    'Riverdale'       => ['riverdale-ri'],
    'East Cambie'     => ['east-cambie'],
    'Brighouse'       => ['brighouse'],
    'Brighouse South' => ['brighouse-south'],
    'West Cambie'     => ['west-cambie-ri'],
    'Sea Island'      => ['sea-island-ri'],
];
...
try {
    $q = $pdo->prepare("
        ...
        WHERE nb.area='Richmond' AND nb.is_active=1
...
<!-- HERO — upload your Richmond city photo to /assets/img/richmond/richmond-hero.webp -->
<div class="nbcity-hero" style="background-image:url('/assets/img/richmond/richmond-hero.webp');">
    ...
    <div class="container h-100 position-relative" style="z-index:2;">
        <div class="row h-100 align-items-center">
            <div class="col-lg-7">
                ...
                <h1 class="nbcity-title">Richmond</h1>
...
<section style="background:#fff;padding:0;overflow:hidden;">
    <div style="display:flex;align-items:stretch;min-height:480px;">
        ...
        ">
            <div class="nbcity-label">About Richmond</div>
            <p class="nbcity-intro-body">Richmond is one of Metro Vancouver's most dynamic real estate markets — landmark towers in City Centre, heritage fishing village character in Steveston, and quiet residential streets in Broadmoor and Seafair.</p>
            <p class="nbcity-intro-body">Sitting directly on the Canada Line and minutes from YVR, Richmond attracts buyers who want suburban space with urban connectivity. Wynston tracks all <?= $total ?> MLS sub-areas with real monthly market data.</p>
...
<section style="background:#f8f9fc;padding:60px 0 90px;">
    <div class="container">
        <div class="row mb-3 align-items-center">
            <div class="col"><div class="nbcity-area-label">Richmond Neighbourhoods</div></div>
        ...
        ?>
        <div class="row g-3 mb-2" id="ri-visible">
            ...
            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                <a href="<?= $link ?>" class="nbcity-nb-card">
                    <div class="nbcity-nb-img" style="background-image:url('<?= $photo ?>')"></div>
        ...
        <?php if (!empty($hidden)): ?>
        <div class="row g-3 mb-2" id="ri-hidden" style="display:none;">
        ...
        <div class="text-center mt-2">
            <button class="nbcity-expand-btn" onclick="toggleSection('ri-hidden','ri-btn',<?=$total?>)" id="ri-btn">
...
.nbcity-hero-overlay{position:absolute;inset:0;background:linear-gradient(160deg,rgba(0,15,40,.05) 0%,rgba(0,40,90,.05) 100%);}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ── Richmond neighbourhood data ───────────────────────────────────────────
    var bySlug = {};
    <?php foreach ($nbs as $nb):
        $photo = nb_photo($nb); ?>
    bySlug[<?= json_encode($nb['slug']) ?>] = {
        name:  <?= json_encode($nb['name']) ?>,
        slug:  <?= json_encode($nb['slug']) ?>,
        photo: <?= json_encode($photo) ?>,
        total: <?= (int)$nb['cs_count'] + (int)$nb['active_count'] ?>
    };
    <?php endforeach; ?>
    ...
    function makePopup(geoName, slugs) {
        ...
        return '<div style="font-family:system-ui;min-width:210px;">'
            +'<div style="font-size:10px;color:#0065ff;font-weight:700;text-transform:uppercase;letter-spacing:.7px;margin-bottom:6px;">Richmond</div>'
    ...
    fetch('metro-vancouver.geojson')
        ...
        .then(function(data) {
            ...
            data.features.forEach(function(f) {
                ...
                if (!city || city === 'richmond' || !otherCities[city]) return;
            ...
            // ── Step 2: Load Richmond neighbourhoods on top ───────────────────
            return fetch('richmond-boundaries.geojson');
        })
        .then(function(r){ return r.json(); })
