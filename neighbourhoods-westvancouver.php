...
// ── Neighbourhood card photos — /assets/img/west-vancouver/ ────────────────────
$nb_photos = [
    'altamont'           => '/assets/img/west-vancouver/Altamont.webp',
    'ambleside'          => '/assets/img/west-vancouver/Ambleside.webp',
    'bayridge'           => '/assets/img/west-vancouver/Bayridge.webp',
    'british-properties' => '/assets/img/west-vancouver/British Properties.webp',
    'canterbury'         => '/assets/img/west-vancouver/Canterbury.webp',
    'caulfeild'          => '/assets/img/west-vancouver/Caulfeild.webp',
    'cedardale'          => '/assets/img/west-vancouver/Cedardale.webp',
    'chartwell'          => '/assets/img/west-vancouver/Chartwell.webp',
    'chelsea-park'       => '/assets/img/west-vancouver/Chelsea Park.webp',
    'deer-ridge'         => '/assets/img/west-vancouver/Deer Ridge.webp',
    'dundarave'          => '/assets/img/west-vancouver/Dundarave.webp',
    'eagle-harbour'      => '/assets/img/west-vancouver/Eagle Harbour.webp',
    'eagle-ridge'        => '/assets/img/west-vancouver/Eagle Ridge.webp',
    'gleneagles'         => '/assets/img/west-vancouver/Gleneagles.webp',
    'glenmore'           => '/assets/img/west-vancouver/Glenmore.webp',
    'horseshoe-bay'      => '/assets/img/west-vancouver/Horseshoe Bay.webp',
    'olde-caulfeild'     => '/assets/img/west-vancouver/Olde Caulfeild.webp',
    'panorama-village'   => '/assets/img/west-vancouver/Panorama Village.webp',
    'park-royal'         => '/assets/img/west-vancouver/Park Royal.webp',
    'queens'             => '/assets/img/west-vancouver/Queens.webp',
    'rockridge'          => '/assets/img/west-vancouver/Rockridge.webp',
    'sandy-cove'         => '/assets/img/west-vancouver/Sandy Cove.webp',
    'sentinel-hill'      => '/assets/img/west-vancouver/Sentinel Hill.webp',
    'upper-caulfeild'    => '/assets/img/west-vancouver/Upper Caulfeild.webp',
    'west-bay'           => '/assets/img/west-vancouver/West Bay.webp',
    'westhill'           => '/assets/img/west-vancouver/Westhill.webp',
    'westmount'          => '/assets/img/west-vancouver/Westmount.webp',
    'whitby-estates'     => '/assets/img/west-vancouver/Whitby Estates.webp',
    'whytecliff'         => '/assets/img/west-vancouver/Whytecliff.webp',
    'cypress'            => '/assets/img/west-vancouver/Cypress.webp',
    'cypress-park-estates'=> '/assets/img/west-vancouver/Cypress Park Estates.webp',
    'furry-creek'        => '/assets/img/west-vancouver/Furry Creek.webp',
    'howe-sound'         => '/assets/img/west-vancouver/Howe Sound.webp',
    'lions-bay'          => '/assets/img/west-vancouver/Lions Bay.webp',
    'passage-island'     => '/assets/img/west-vancouver/Passage Island.webp',
    'porteau'            => '/assets/img/west-vancouver/Porteau.webp',
];
...
try {
    $q = $pdo->prepare("
        ...
        WHERE nb.area='West Vancouver' AND nb.is_active=1
...
<!-- HERO -->
<div class="nbcity-hero" style="background-image:url('/assets/img/west-vancouver/west-vancouver-hero.webp');">
    ...
    <div class="container h-100 position-relative" style="z-index:2;">
        <div class="row h-100 align-items-center">
            <div class="col-lg-7">
                ...
                <h1 class="nbcity-title">West Vancouver</h1>
...
<section style="background:#fff;padding:0;overflow:hidden;">
    <div style="display:flex;align-items:stretch;min-height:480px;">
        ...
        ">
            <div class="nbcity-label">About West Vancouver</div>
            <p class="nbcity-intro-body">West Vancouver consistently ranks among Canada’s wealthiest municipalities — stretching from the Burrard Inlet waterfront to the alpine heights of Cypress Mountain. World-class villages like Ambleside and Dundarave sit alongside prestigious hillside estates in the British Properties and Chartwell.</p>
            <p class="nbcity-intro-body">Secluded western communities around Horseshoe Bay and Howe Sound complete the picture. Wynston tracks all <?= $total ?> MLS sub-areas with real monthly market data.</p>
...
<section style="background:#f8f9fc;padding:60px 0 90px;">
    <div class="container">
        <div class="row mb-3 align-items-center">
            <div class="col"><div class="nbcity-area-label">West Vancouver Neighbourhoods</div></div>
        ...
        ?>
        <div class="row g-3 mb-2" id="wv-visible">
...
echo "<!-- slug: $slug | photo: $photo -->";
            ...
            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                <a href="<?= $link ?>" class="nbcity-nb-card">
                    <div class="nbcity-nb-img" style="background-image:url('<?= htmlspecialchars(str_replace(' ', '%20', $photo)) ?>')"></div>
        ...
        <?php if (!empty($hidden)): ?>
        <div class="row g-3 mb-2" id="wv-hidden" style="display:none;">
        ...
        <div class="text-center mt-2">
            <button class="nbcity-expand-btn" onclick="toggleSection('wv-hidden','wv-btn',<?= $total ?>)" id="wv-btn">
...
<style>
.nbcity-hero{position:relative;height:580px;display:flex;align-items:center;background-size:cover;background-position:center 55%;}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ── West Vancouver neighbourhood data ─────────────────────────────────────
    var bySlug = {};
    ...
    geoSlugMap['Cypress']              = ['cypress'];
    geoSlugMap['Cypress Park Estates'] = ['cypress-park-estates'];
    geoSlugMap['Howe Sound']           = ['howe-sound'];
    geoSlugMap['Lions Bay']            = ['lions-bay'];
    geoSlugMap['Porteau']              = ['porteau'];
    geoSlugMap['Furry Creeks']         = ['furry-creek'];
    geoSlugMap['Passage Island']       = ['passage-island'];
    ...
    function makePopup(geoName, slugs) {
        ...
        return '<div style="font-family:system-ui;min-width:210px;">'
            +'<div style="font-size:10px;color:#0065ff;font-weight:700;text-transform:uppercase;letter-spacing:.7px;margin-bottom:6px;">West Vancouver</div>'
    ...
    fetch('metro-vancouver.geojson')
        ...
        .then(function(data) {
            ...
            data.features.forEach(function(f) {
                ...
                if (!city || city === 'westvancouver' || !otherCities[city]) return;
            ...
            // ── Step 2: Load West Vancouver neighbourhoods on top ─────────────
            return fetch('westvancouver-boundaries.geojson');
        })
        .then(function(r){ return r.json(); })
